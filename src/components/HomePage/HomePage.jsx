  ...
  return (
    <Container>
      ...
      <HomeBody>
        ...
        <Operation>
          ...
          <ul>
            <li>
              ...
              <span>Seller</span>
              <p>
                We have a smooth and user friendly operating standard,
        ...
        <MarketGallery>
          <div>
            <img src="/Market1.webp" alt="Market gallery" />
          </div>
          <div>
            <img src="/Market2.webp" alt="Market gallery" />
          </div>
          <div>
            <img src="/Market4.webp" alt="Market gallery" />
          </div>
          <div>
            <Link href="/Market">
          ...
          <div>
            <img src="/Market5.webp" alt="Market gallery" />
          </div>
        </MarketGallery>
        <FAQ>
          ...
          <ul>
            ...
            <li>
              <p>How will the product be delivered when I buy?</p>
              <RiArrowDropDownLine />
            </li>
            <li>
              <p>Can I inspect the product before payment?</p>
              <RiArrowDropDownLine />
            </li>
            <li>
              <p>How do you make your own profit?</p>
              <RiArrowDropDownLine />
            </li>
          </ul>
        </FAQ>
